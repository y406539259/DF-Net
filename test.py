...
models_list = ['UNet512', 'M_Net', "FM_Net_SelfLearning", "GuildNetwork", "SU_Net"]
...
parser.add_argument('--my_description', type=str, default='testCHASEDB1',
...
def fast_test(model, args, img_list, model_name, epoch):
...
if __name__ == '__main__':
    ...
    if True:
        ...
        model_path = "/home/yinpengshuai/FrangiNetNew/models/FM_Net_SelfLearning_CHASEDB1_PreTrain_1_0.001/11_0.98109996.pth"
    ...
    fast_test(model, args, test_img_list, model_name, 0)
